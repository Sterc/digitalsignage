...
;(function($, window, document, undefined) {
     ...
     * @param {HTMLElement} element - The element of the Buienradar Slide.
     * @param {Array} options - The options of the Buienradar Slide.
     * @param {Object} core - The DigitalSignage object for the Buienradar Slide.
     */
    ...
    SlideBuienradar.Defaults = {
        ...
        weatherIcon     : '/digitalsignage/assets/interface/images/slide-buienradar/weather/{icon}.svg',
        windIcon        : '/digitalsignage/assets/interface/images/slide-buienradar/wind/{icon}.svg',
    ...
    SlideBuienradar.prototype.loadForcast = function() {
        ...
        $.ajax({
            url         : this.core.getAjaxUrl(this.settings.forecast.replace('{location}', this.getLocation())),
    ...
    /**
     * Strips the location ID of the Buienradar URL.
     */
    SlideBuienradar.prototype.getLocation = function() {
        var locationID = this.settings.location.match(/(?:https?:\/{2})?(?:w{3}\.)?buienradar.nl\/(.*?)\/([0-9]+)/);

        if (null !== locationID && locationID[2]) {
            return locationID[2];
        }
    ...
    /**
     * The lexicons for the Buienradar Slide.
     */
