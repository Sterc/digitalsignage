...
$instance = $modx->getService('narrowcasting', 'Narrowcasting', $modx->getOption('narrowcasting.core_path', null, $modx->getOption('core_path').'components/narrowcasting/').'model/narrowcasting/');

if ($instance instanceOf Narrowcasting) {
