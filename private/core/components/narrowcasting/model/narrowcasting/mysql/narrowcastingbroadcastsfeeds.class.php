<?php
	...
	require_once dirname(dirname(__FILE__)).'/narrowcastingbroadcastsfeeds.class.php';
	
	class NarrowcastingBroadcastsFeeds_mysql extends NarrowcastingBroadcastsFeeds {}
