<?php
	...
	require_once dirname(dirname(__FILE__)).'/narrowcastingbroadcastsplayers.class.php';
	
	class NarrowcastingBroadcastsPlayers_mysql extends NarrowcastingBroadcastsPlayers {}
