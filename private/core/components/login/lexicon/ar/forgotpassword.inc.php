 ...
 */
/**
 * Forgot Password Arabic lexicon for Login
 *
 * @package login
 * @subpackage lexicon
 */
...
$_lang['login.user_err_nf_email'] = 'لا يوجد مستخدم بهذا العنوان';
$_lang['login.user_err_nf_username'] = 'لا يوجد مستخدم بهذا الاسم';
