<?php
    ...
    $xpdo_meta_map = array(
        'xPDOSimpleObject' => array(
            ...
            1 => 'NarrowcastingBroadcastsFeeds',
            2 => 'NarrowcastingBroadcastsSlides',
            3 => 'NarrowcastingPlayers',
            4 => 'NarrowcastingPlayersSchedules',
            5 => 'NarrowcastingSlides',
            6 => 'NarrowcastingSlidesTypes'
        )
    );
