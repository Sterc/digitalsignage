<?php
    ...
    $_lang['setting_digitalsignagesocialmedia.twitter_query_desc']              = 'De Twitter query, usernames beginnen met een @ en hastags beginnen met een #.';
    ...
    $_lang['setting_digitalsignagesocialmedia.instagram_query_desc']            = 'De Instagram query, usernames beginnen met een @ en hastags beginnen met een #.';
    //$_lang['setting_digitalsignagesocialmedia.instagram_user_id']               = 'Instagram User ID';
    //$_lang['setting_digitalsignagesocialmedia.instagram_user_id_desc']          = '';
    //$_lang['setting_digitalsignagesocialmedia.facebook_page']                   = 'Facebook Page';
    //$_lang['setting_digitalsignagesocialmedia.facebook_page_desc']              = '';
