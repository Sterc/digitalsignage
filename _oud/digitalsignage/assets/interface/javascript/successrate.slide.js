...
;(function($, window, document, undefined) {
     ...
     * @param {Core} Object - The DigitalSignage object for the SuccessRate Slide.
     */
    function SlideSuccessRate(element, options, core) {
        /**
         * The DigitalSignage object for the SuccessRate Slide.
         * @public.
         */
        this.core = core;
    ...
    $.fn.SlideSuccessRate = function(option, core) {
        ...
        return this.each(function() {
            var $this = $(this),
                data = $this.data('digitalsignage.slidesuccessrate');

            if (!data) {
                data = new SlideSuccessRate(this, typeof option == 'object' && option, core);

                $this.data('digitalsignage.slidesuccessrate', data);

                $.each([], function(i, event) {
                    data.register({ type: SlideSuccessRate.Type.Event, name: event });

                    data.$element.on(event + '.digitalsignage.slidesuccessrate.core', $.proxy(function(e) {
