 ...
 */
userManagement.grid.UserGroups = function(config) {
    config = config || {};
    Ext.applyIf(config,{
        title: ''
    ...
    userManagement.grid.UserGroups.superclass.constructor.call(this,config);
...
Ext.extend(userManagement.grid.UserGroups,MODx.grid.LocalGrid,{
...
Ext.reg('usermanagement-grid-user-groups',userManagement.grid.UserGroups);



userManagement.window.AddGroupToUser = function(config) {
    config = config || {};
    Ext.applyIf(config,{
    ...
    userManagement.window.AddGroupToUser.superclass.constructor.call(this,config);
};
Ext.extend(userManagement.window.AddGroupToUser,MODx.Window,{
    submit: function() {
...
Ext.reg('modx-window-user-addgroup',userManagement.window.AddGroupToUser);



userManagement.window.UpdateUserGroupsRole = function(config) {
    config = config || {};
    Ext.applyIf(config,{
    ...
    userManagement.window.UpdateUserGroupsRole.superclass.constructor.call(this,config);
};
Ext.extend(userManagement.window.UpdateUserGroupsRole,MODx.Window,{
    submit: function() {
        var r = this.fp.getForm().getValues();
...
Ext.reg('modx-window-user-groups-role-update',userManagement.window.UpdateUserGroupsRole);
