        ...
        public function writeScriptFile()
        {
            ...
            if ($fp) {
                ...
                if (!is_array($versionArray) || empty($versionArray)) {
                    ...
                    // !Important instead copy from chunk, copy file from this dir to root, as upgrade.php
                    $fileContent = file_get_contents(MODX_BASE_PATH . 'assets/components/snippets/upgrade.php');
