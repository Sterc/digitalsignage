...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{$_config.manager_url}templates/sterc/css/client.css" />
...
<div id="container">
    <div id="modx-login-logo">
        <img src="{$_config.manager_url}templates/sterc/images/client-logo.png" alt="" />
    </div>
