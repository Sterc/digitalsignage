...
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}templates/sterc/css/sterc.css" />
    ...
    <div id="modx-header">
        <div id="modx-navbar">
            <ul id="modx-user-menu">
                ...
                {$username = ($profile->get('fullname')) ? $profile->get('fullname') : $username}
                {eval var=$userNav}
                <li id="sterc-logo"><img src="{$_config.manager_url}templates/sterc/images/sterc-logo-small.png"/></li>
            </ul>
