...
if (null !== ($oldPackage = $modx->getObject('transport.modTransportPackage', $c))) {
...
if (null !== ($userNameObj = $modx->getObject('modSystemSetting', array('key' => strtolower($package) . '.user_name')))) {
    $userName = $userNameObj->get('value');
}

if (null !== ($userEmailObj = $modx->getObject('modSystemSetting', array('key' => strtolower($package) . '.user_email')))) {
    $userEmail = $userEmailObj->get('value');
}

if (null !== ($modxVersionObj = $modx->getObject('modSystemSetting', array('key' => 'settings_version')))) {
    $modxVersion = $modxVersionObj->get('value');
}
